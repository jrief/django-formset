...
import {DualRangeNumberElement} from './django-formset/DualRangeNumber';
...
function handleDOMLoaded() {
	...
	window.customElements.define('django-dual-range-number', DualRangeNumberElement, {extends: 'input'});
	customElementNames.push('django-dual-range-number');
