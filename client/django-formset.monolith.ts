...
import {DualNumberRangeElement} from './django-formset/NumberRange';
...
function handleDOMLoaded() {
	...
	window.customElements.define('django-dual-number-range', DualNumberRangeElement, {extends: 'input'});
	customElementNames.push('django-dual-number-range');
