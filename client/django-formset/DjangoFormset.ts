...
class DjangoFormCollection {
	...
	public markAsFreshAndEmpty(justAddded?: boolean) {
		this.children.forEach(child => child.markAsFreshAndEmpty(justAddded));
		if (justAddded) {
