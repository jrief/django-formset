    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(db_index=True, editable=False, max_length=40)),
                ('reporter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='testapp.reporter', verbose_name='Reporter')),
                ('reporters', models.ManyToManyField(blank=True, to='testapp.reporter', verbose_name='Reporters')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', models.CharField(blank=True, max_length=25, null=True, validators=[django.core.validators.RegexValidator(message="Phone number have 4-25 digits and may start with '+'.", regex='^\\+?[ 0-9.\\-]{4,25}$')], verbose_name='Phone Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('free', models.BooleanField(default=False, verbose_name='Free of Charge')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Amount')),
            ],
        ),
        migrations.CreateModel(
            name='EventOccurrenceModel',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('venue', models.CharField(max_length=100, verbose_name='Venue')),
                ('begin', models.DateTimeField()),
                ('until', models.DateTimeField()),
                ('event_series', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='occurrences', to='testapp.eventseriesmodel')),
            ],
            options={'verbose_name': 'Event Occurrence', 'verbose_name_plural': 'Event Occurrence', 'ordering': ['begin']},
        ),
        migrations.AddField(
            model_name='eventseriesmodel',
            name='fees',
            field=models.ManyToManyField(to='testapp.feemodel', verbose_name='Entrance Fees'),
        ),
