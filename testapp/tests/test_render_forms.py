...
def test_simple_collection_get(initial, rf):
...
def test_simple_collection_post(rf):
    ...
    request = rf.post('/', data={'formset_data': formset_data}, content_type='application/json')
...
def test_collection_post(counter, formset_data, rf):
    view = FormCollectionView.as_view(
        collection_class=ContactCollection,
        success_url='/success',
        template_name='bootstrap/form-collection.html',
