...
urlpatterns = [
    ...
    path('combined', CombinedFormsView.as_view(template_name='default/formcollection.html')),
    ...
    path('bootstrap/selectize', SubscribeFormView.as_view(form_class=SelectForm, template_name='bootstrap/render_groups.html')),
