...
urlpatterns = [
    ...
    path('selectize', SubscribeFormView.as_view(form_class=SelectForm, template_name='default/selectize.html')),
    ...
    path('bootstrap/selectize', SubscribeFormView.as_view(form_class=SelectForm, template_name='bootstrap/selectize.html')),
    ...
    path('bulma/selectize', SubscribeFormView.as_view(form_class=SelectForm, template_name='bulma/selectize.html')),
